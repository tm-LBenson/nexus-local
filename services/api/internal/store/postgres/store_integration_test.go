...
func newIntegrationStore(t *testing.T, ctx context.Context) *Store {
	...
	if _, err := repo.pool.Exec(ctx, `
		TRUNCATE tenants, users, memberships, documents, jobs, messages, conversations, audit_events, data_sources, data_source_scan_entries, source_views, source_policy_profiles
	`); err != nil {
